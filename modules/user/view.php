...
<section class="content-header">
  <div class="container-fluid">
    <h1>
      <i class="ml-4 fa fa-user icon-title"></i> Manajemen User
      ...
      <div class="card card-outline card-dark shadow">
        <div class="card-body">
          ...
          <table id="dataTb2" class="table">
            ...
            $query = mysqli_query($config, "SELECT * FROM tbl_users ORDER BY id_user DESC")
            ...
            // menampilkan isi tabel dari database ke tabel di aplikasi
              echo "<tr>
                      ...
                      if ($data['foto']=="") { ?>
                        <td class='center'><img class='img-user' src='images/user/user-default.png' width='40'></td>
                      <?php
                      } else { ?>
              ...
              echo "  <td>$data[username]</td>
                      ...
                      <td class='center' width='100'>
                          ...
                          if ($data['status']=='aktif') { ?>
                            <a data-toggle="tooltip" data-placement="top" title="Blokir" style="margin-right:5px" class="btn btn-warning" href="modules/user/proses.php?act=off&id=<?php echo $data['id_user'];?>">
                            <i class="fas fa-ban"></i>
                            </a>
            <?php
                          } 
                          else { ?>
                            <a data-toggle="tooltip" data-placement="top" title="Aktifkan" style="margin-right:5px" class="btn btn-success" href="modules/user/proses.php?act=on&id=<?php echo $data['id_user'];?>">
                            <i class="fas fa-power-off"></i>
                            </a>
            <?php
                          }

              echo "      <a data-toggle='tooltip' data-placement='top' title='Ubah' class='btn btn-primary' href='?module=form_user&form=edit&id=$data[id_user]'>
