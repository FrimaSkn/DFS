                ...
                case 'fsm':
                    ...
                    <section class="content-header">
                        <div class="container-fluid">
                            <h1><i class="fa fa-image icon-title"></i> Galeri Surat Masuk</h1>
                        </div>
                    </section>
                    <!-- Row END -->
                                ...
                                <div class="card-body">
                                    ...
                                    if(isset($_REQUEST['submit'])){
                                        ...
                                        if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                                            header("Location: ./main.php?module=gsm");
                                            die();
                                        } else {
                            ...
                            if(mysqli_num_rows($query) > 0){
                                ...
                                if(empty($row['file'])){
                                    ...
                                    if(in_array($eks, $ekstensi) == true){
                                        echo '
                                            <div class="col-3">
                                                <img style="border:1px solid #444;border-radius:5px;" class="galeri" data-caption="'.indoDate($row['tgl_diterima']).'" src="./upload/surat_masuk/'.$row['file'].'"/>
                                                <a class="col btn btn-info my-2" href="?module=gsm&act=fsm&id_surat='.$row['id_surat'].'">Tampilkan Ukuran Penuh</a>
                                            </div>';
                                    } else {
                                        ...
                                        if(in_array($eks, $ekstensi2) == true){
                                            echo '
                                                <div class="col-3">
                                                    <img class="galeri" data-caption="'.indoDate($row['tgl_diterima']).'" src="./assets/img/word.png"/>
                                                    <a class="col btn btn-info my-2" href="?module=gsm&act=fsm&id_surat='.$row['id_surat'].'">Lihat Detail File</a>
                                                </div>';
                                        } else {
                                            echo '
                                                <div class="col-3">
                                                    <img class="galeri" data-caption="'.indoDate($row['tgl_diterima']).'" src="./assets/img/pdf.png"/>
                                                    <a class="col btn btn-info my-2" href="?module=gsm&act=fsm&id_surat='.$row['id_surat'].'">Lihat Detail File</a>
                                                </div>
                                            </div>';
                                        }
