            ...
            while($row = mysqli_fetch_array($query)){ ?>
                    ...
                    <section class="content-header">
                        <div class="container-sm">
                            <h1>
                                <i class="fas fa-info-circle"></i> Detail file Surat Masuk
                                        ...
                                        <div class="col-5">
                                            ...
                                            if(empty($row['file'])){
                                                ...
                                                if(in_array($eks, $ekstensi) == true){
                                                    echo '<img class="file" data-caption="'.date('d M Y', strtotime($row['tgl_diterima'])).'" src="./upload/surat_masuk/'.$row['file'].'"/>';
                                                } else {
