    	...
    	if(mysqli_num_rows($query) > 0){
            ...
            if($_SESSION['id_user'] != $row['id_user'] AND $_SESSION['id_user'] != 1){
                echo '<script language="javascript">
                        ...
                        window.location.href="./mian.php?module=surat_masuk";
                      </script>';
            } else {
                ...
                <div class="container-sm">
                    <div class="col-md-12">
				        ...
				        <table>
				            ...
				            <tbody>
    			                ...
    			                <tr>
    			                    ...
    			                    <td width="86%">';
                                    if(!empty($row['file'])){
                                        echo ' <a class="blue-text" href="?module=gsm&act=fsm&id_surat='.$row['id_surat'].'">'.$row['file'].'</a>';
                                    } else {
                        ...
                        <div class="modal-footer">
        	                <a href="?module=surat_masuk&act=del&submit=yes&id_surat='.$row['id_surat'].'" class="btn btn-danger"><i class="fa fa-trash"></i> HAPUS</a>
        	                <a href="?module=surat_masuk" class="btn btn-secondary"><i class="fas fa-times"></i> BATAL</a>
    	                </div>
                        </div><!-- /.box -->
                        </div><!-- /.box -->
                    </div><!--/.col -->
                    ...
                    if(!empty($row['file'])){
                		...
                		if($query == true){
                           ...
                           echo '<script language="javascript">
                            ...
                            echo '<script language="javascript">
                                    window.location.href="../main.php?module=del_sm&id_surat='.$id_surat.'";
                                  </script>';
                		}
                	} else {
