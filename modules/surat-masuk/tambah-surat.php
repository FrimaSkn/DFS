        ...
        if(isset($_REQUEST['submit'])){
                                                ...
                                                if($result > 0){
                                                    ...
                                                    if($file != ""){
                                                        ...
                                                        if(in_array($eks, $ekstensi) == true){
                                                            ...
                                                            echo '<script language="javascript">
                                                            window.location.href="./main.php?module=surat_masuk&alert=7";
                                                        </script>';
                                                        }
                                                    } else {
            ...
            <section class="content-header">
                <div class="container-sm">
                    <h1><i class="fa fa-envelope icon-title ml-4"></i> Tambah Data Surat Masuk</h1>
                </div>
            </section>
            ...
            <section class="content">
                <div class="container-sm">
                    <div class="col-md-12">
                        ...
                        <div class="card-body">
                            <!-- Form START -->
                            <form class="container-sm" method="POST" action="?module=surat_masuk&act=add" enctype="multipart/form-data">
                                ...
                                <div class="row row-cols-2">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <?php
                                            echo '<input class="form-control" id="no_agenda" type="number" class="validate" name="no_agenda" value="';
                                    ...
                                    <div class="col">
                                        ...
                                        <input class="form-control" id="kode" type="text" class="validate" name="kode" required>
                                            <?php
                                    ...
                                    <div class="col">
                                        ...
                                        <input class="form-control" id="asal_surat" type="text" class="validate" name="asal_surat" required>
                                            <?php
                                    ...
                                    <label for="indeks">Indeks Berkas</label>
                                        <input class="form-control" id="indeks" type="text" class="validate" name="indeks" required>
                                            <?php
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="no_surat" type="text" class="validate" name="no_surat" required>
                                                <?php
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control datepicker" id="tgl_surat" type="text" name="tgl_surat" autocomplete="off" required>
                                            <?php
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="isi" class="materialize-textarea validate" name="isi" required></textarea>
                                            <?php
                                    ...
                                    <div class="col">
                                         <div class="form-group">
                                            ...
                                            <input class="form-control" id="keterangan" type="text" class="validate" name="keterangan" required>
                                            <?php
